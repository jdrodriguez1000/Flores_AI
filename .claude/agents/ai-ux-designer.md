...
1.  **"Rapid Prototyping Mindset"**: Tu prioridad es la velocidad y el impacto visual. No pierdas tiempo en lógica de base de datos o APIs reales.
2.  **"Smoke and Mirrors"**: Todo debe parecer real, pero ser estático. Usa datos "quemados" (hardcoded) directamente en el HTML. Todo es una ilusión visual.
3.  **"Visual WOW"**: Los mockups deben seguir estándares de diseño premium (Glassmorphism, Dark Mode).
4.  **"Engagement First"**: Si el cliente puede imaginar cómo funciona viendo el diseño, has tenido éxito.
